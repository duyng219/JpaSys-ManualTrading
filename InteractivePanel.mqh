...
class CInteractivePanel: public CAppDialog
{
    protected:
        ...
        void BuyOnClick() 
        {
            ...
            trade.Buy(0.01,Symbol(),ask,stoploss,takeprofit);
        }
        ...
        void SellOnClick() 
        {
            ...
            trade.Sell(0.01,Symbol(),bid,stoploss,takeprofit);
        }
...
bool CInteractivePanel::CreatePanel(string name, int x1, int y1, int x2, int y2)
{
    ...
    int x_mm = int(x1 + panel_width * 0.05);
    int y_mm = int(y1 + panel_height);
    //Label
    CreateLabel(trade_management_menu.trade_protection_label, x_mm, int(y_mm * 0.20), label_width, "trade_protection_label", "Trade Protection");
    CreateLabel(trade_management_menu.trailing_step_label, x_mm, int(y_mm * 0.30), label_width, "trailing_step_label", "Trailing Step[Pts]");
    CreateLabel(trade_management_menu.trailing_stop_label, x_mm, int(y_mm * 0.40), label_width, "trailing_stop_label", "Trailing Stop[Pts]");
    CreateLabel(trade_management_menu.break_even_label, x_mm, int(y_mm * 0.50), label_width, "break_even_label", "Break Even");
    CreateLabel(trade_management_menu.magic_number_label, x_mm, int(y_mm * 0.60), label_width, "magic_number_label", "Magic Number");
    CreateLabel(trade_management_menu.close_all_label, x_mm, int(y_mm * 0.70), label_width, "close_all_label", "Bulk Action");
    
    //Value
    CreateComboBox(trade_management_menu.trade_protection_dropdown,int(x1 + panel_width * 0.4), int(y_mm * 0.19), 190, 40,"trade_protecion_dd");
    ...
    CreateEdit(trade_management_menu.trailing_step_edit,int(x1 + panel_width * 0.4),int(y_mm * 0.30), 190, 40, "trailing-step input","10");
    CreateEdit(trade_management_menu.trailing_stop_edit,int(x1 + panel_width * 0.4),int(y_mm * 0.40), 190, 40, "trailing-stop input","5");
    CreateEdit(trade_management_menu.break_even_stop_edit,int(x1 + panel_width * 0.4),int(y_mm * 0.50), 190, 40, "break-even-stop input","20");
    CreateEdit(trade_management_menu.magic_number_edit,int(x1 + panel_width * 0.4),int(y_mm * 0.60), 190, 40, "magic_number-edit","0");

    CreateButton(trade_management_menu.close_all_button,int(x1 + panel_width * 0.4), int(y_mm * 0.70),40,190,"close-all-btn", "Close All");
